...
class MainAppWindow(ctk.CTk):
    """The main application window for the Personality Prediction App."""
    ...
    def __init__(self):
        ...
        self.hyperlink_label = ctk.CTkLabel(self, text="Learn more about OPS", font=("Arial", 14), cursor="hand2",
                                            text_color="#1F6AA5")
